...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 This specification is based on ``Two-Phase \ensuremath{Commit}'', Lecture 6
 of the
...
\@x{ {\CONSTANT} RM\@s{4.1}}%
\@y{\@s{0}%
 The set of all Resource Managers (\ensuremath{e.g}.
 \ensuremath{\{\mbox{``}r1\mbox{''},\, \mbox{``}r2\mbox{''},\,
 \mbox{``}r3\mbox{''}\}}).
}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{ {\VARIABLES}}%
\@x{\@s{8.2} rmState ,\,\@s{15.11}}%
\@y{\@s{0}%
 \ensuremath{rmState[rm]} is the state of the Resource Manager
 \ensuremath{rm}.
}%
\@xx{}%
\@x{\@s{8.2} tmState ,\,\@s{16.00}}%
\@y{\@s{0}%
 Transaction Manager state: \ensuremath{\@w{init}} or \ensuremath{\@w{done}}.
}%
\@xx{}%
\@x{\@s{8.2} tmPrepared ,\,}%
\@y{\@s{0}%
 The set of resource managers the transaction manager knows are prepared.
}%
\@xx{}%
\@x{\@s{8.2} msgs}%
\begin{lcom}{16.4}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 are sent
 from the \ensuremath{RM} indicated by the message\mbox{'}s \ensuremath{rm}
 field to the \ensuremath{TM}. Messages of
 type \ensuremath{\@w{Commit}} and \ensuremath{\@w{Abort}} are broadcast by
 the \ensuremath{TM}, to be received by
 all \ensuremath{RMs}. The set \ensuremath{msgs} contains just a single copy
 of such message.
\end{cpar}%
\end{lcom}%
 \@x{ Messages\@s{10.22} \.{\defeq} [ type \.{:} \{\@w{Prepared} \} ,\, rm
 \.{:} RM ] \.{\cup} [ type \.{:} \{\@w{Commit} ,\,\@w{Abort} \} ]}%
\@pvspace{8.0pt}%
 \@x{ TPTypeOK \.{\defeq} \.{\land} rmState \.{\in} [ RM \.{\rightarrow}
 \{\@w{working} ,\,\@w{prepared} ,\,}%
\@x{\@s{170.88}\@w{committed} ,\,\@w{aborted} \} ]}%
 \@x{\@s{70.07} \.{\land} tmState\@s{0.89} \.{\in} \{\@w{init} ,\,\@w{done}
 \}}%
\@x{\@s{70.07} \.{\land} tmPrepared \.{\subseteq} RM}%
\@x{\@s{70.07} \.{\land} msgs \.{\subseteq} Messages}%
\@pvspace{16.0pt}%
 \@x{ TPInit \.{\defeq} \.{\land} rmState \.{=} [ r \.{\in} RM
 \.{\mapsto}\@w{working} ]}%
\@x{\@s{49.64} \.{\land} tmState\@s{0.89} \.{=}\@w{init}}%
\@x{\@s{49.64} \.{\land} tmPrepared \.{=} \{ \}}%
\@x{\@s{49.64} \.{\land} msgs \.{=} \{ \}}%
\@pvspace{8.0pt}%
\@x{}\midbar\@xx{}%
\@pvspace{8.0pt}%
\@x{ TMRecvPrepared ( r ) \.{\defeq}\@s{8.2}}%
\@y{\@s{0}%
...
\@x{ TMCommit \.{\defeq}}%
\@y{\@s{0}%
 The \ensuremath{TM} commits the transaction
}%
\@xx{}%
\@x{\@s{8.2} \.{\land} tmState \.{=}\@w{init}}%
\@x{\@s{8.2} \.{\land} tmState \.{'} \.{=}\@w{done}\@s{94.29}}%
\@y{\@s{0}%
 \ensuremath{TM} state transitions
}%
\@xx{}%
\@x{\@s{8.2} \.{\land} tmPrepared \.{=} RM\@s{92.97}}%
\@y{\@s{0}%
 \ensuremath{TM} sees all \ensuremath{RMs} as prepared
}%
\@xx{}%
 \@x{\@s{8.2} \.{\land} rmState \.{=} [ r \.{\in} RM \.{\mapsto}\@w{prepared}
 ]\@s{22.87}}%
\@y{\@s{0}%
 All \ensuremath{RMs} are prepared (nececessary\.{?})
}%
\@xx{}%
 \@x{\@s{8.2} \.{\land} msgs \.{'} \.{=} msgs \.{\cup} \{ [ type
 \.{\mapsto}\@w{Commit} ] \}\@s{11.12}}%
\@y{\@s{0}%
 Send the \ensuremath{Commit} message
}%
\@xx{}%
...
\@xx{}%
 \@x{\@s{8.2} \.{\land} tmState \.{=}\@w{init} \.{\land} tmState \.{'}
 \.{=}\@w{done}\@s{8.2}}%
\@y{\@s{0}%
 \ensuremath{TM} state transitions
}%
\@xx{}%
 \@x{\@s{8.2} \.{\land} msgs \.{'} \.{=} msgs \.{\cup} \{ [ type
 \.{\mapsto}\@w{Abort} ] \}\@s{16.67}}%
\@y{\@s{0}%
 Send the \ensuremath{Abort} message
}%
\@xx{}%
 \@x{\@s{8.2} \.{\land} {\UNCHANGED} {\langle} rmState ,\, tmPrepared
 {\rangle}}%
...
\@x{}\midbar\@xx{}%
\@pvspace{8.0pt}%
\@x{ RMPrepare ( r ) \.{\defeq} \.{\land} rmState [ r ] \.{=}\@w{working}}%
 \@x{\@s{82.07} \.{\land} rmState \.{'} \.{=} [ rmState {\EXCEPT} {\bang} [ r
 ] \.{=}\@w{prepared} ]}%
 \@x{\@s{82.07} \.{\land} msgs \.{'} \.{=} msgs \.{\cup} \{ [ type
 \.{\mapsto}\@w{Prepared} ,\, rm \.{\mapsto} r ] \}}%
 \@x{\@s{82.07} \.{\land} {\UNCHANGED} {\langle} tmState ,\, tmPrepared
 {\rangle}}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{RM} spontaneously chooses to abort.
 No message sent in our simplified model.
\end{cpar}%
\end{lcom}%
 \@x{ RMChooseToAbort ( r )\@s{6.59} \.{\defeq} \.{\land} rmState [ r ]
 \.{=}\@w{aborted}}%
 \@x{\@s{121.84} \.{\land} rmState \.{'} \.{=} [ rmState {\EXCEPT} {\bang} [ r
 ] \.{=}\@w{aborted} ]}%
 \@x{\@s{121.84} \.{\land} {\UNCHANGED} {\langle} tmState ,\, tmPrepared ,\,
 msgs {\rangle}}%
\@pvspace{8.0pt}%
\@x{ RMRecvCommitMsg ( r ) \.{\defeq}}%
\@y{\@s{0}%
 \ensuremath{RM} \ensuremath{r} is told to commit
}%
\@xx{}%
 \@x{\@s{8.2} \.{\land} [ type \.{\mapsto}\@w{Commit} ] \.{\in}
 msgs\@s{36.89}}%
\@y{\@s{0}%
 A \ensuremath{Commit} message should have been sent
}%
\@xx{}%
 ...
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ RMRecvAbortMsg ( r ) \.{\defeq}}%
\@y{\@s{0}%
 \ensuremath{RM} is told to abort
}%
\@xx{}%
\@x{\@s{8.2} \.{\land} [ type \.{\mapsto}\@w{Abort} ] \.{\in} msgs\@s{41.0}}%
\@y{\@s{0}%
 An \ensuremath{Abort} message should have been sent
}%
\@xx{}%
 \@x{\@s{8.2} \.{\land} rmState \.{'} \.{=} [ rmState {\EXCEPT} {\bang} [ r ]
 \.{=}\@w{aborted} ]}%
 ...
 {\rangle}}%
\@pvspace{16.0pt}%
\@x{ TPNext \.{\defeq} \.{\lor} TMCommit\@s{53.3}}%
\@y{\@s{0}%
 The transaction is committed by the \ensuremath{TM}.
}%
\@xx{}%
\@x{\@s{53.77} \.{\lor} TMAbort\@s{64.39}}%
\@y{\@s{0}%
 The transaction is aborted by the \ensuremath{TM}.
}%
\@xx{}%
\@x{\@s{53.77} \.{\lor} \E\, r \.{\in} RM \.{:}\@s{53.30}}%
\@y{\@s{0}%
 A message is sent or received by a \ensuremath{RM} or the \ensuremath{TM}.
}%
\@xx{}%
\@x{\@s{73.08} \.{\lor} TMRecvPrepared ( r )}%
\@x{\@s{73.08} \.{\lor} RMPrepare ( r )}%
\@x{\@s{73.08} \.{\lor} RMChooseToAbort ( r )}%
\@x{\@s{73.08} \.{\lor} RMRecvCommitMsg ( r )}%
\@x{\@s{73.08} \.{\lor} RMRecvAbortMsg ( r )}%
\@pvspace{8.0pt}%
\@x{}\midbar\@xx{}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 \ensuremath{TODO} on Lecture 8
}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{}\bottombar\@xx{}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified Sun \ensuremath{Apr} 04
 10:00:30 \ensuremath{BRT} 2021 by \ensuremath{felipec
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created Sat \ensuremath{Apr} 03 15:07:14
 \ensuremath{BRT} 2021 by \ensuremath{felipec
}%
\end{cpar}%
\end{lcom}%
\end{document}
